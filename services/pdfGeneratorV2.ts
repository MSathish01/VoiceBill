        ...
        ">
          <thead>
            <tr style="background: linear-gradient(135deg, #22d3ee, #06b6d4); color: white;">
              <th style="padding: 12px 8px; text-align: center; border: 1px solid #0891b2; width: 50px; font-family: ${tamilFontFamily};">
                ${isTamil ? 'வ.எண்' : 'S.No'}
              </th>
              <th style="padding: 12px 8px; text-align: left; border: 1px solid #0891b2; font-family: ${tamilFontFamily};">
                ${isTamil ? 'பொருள்' : 'Item'}
              </th>
              <th style="padding: 12px 8px; text-align: center; border: 1px solid #0891b2; width: 90px; font-family: ${tamilFontFamily};">
                ${isTamil ? 'அளவு' : 'Qty'}
              </th>
              <th style="padding: 12px 8px; text-align: right; border: 1px solid #0891b2; width: 85px; font-family: ${tamilFontFamily};">
                ${isTamil ? 'விலை (₹)' : 'Rate (₹)'}
              </th>
              <th style="padding: 12px 8px; text-align: right; border: 1px solid #0891b2; width: 85px; font-family: ${tamilFontFamily};">
